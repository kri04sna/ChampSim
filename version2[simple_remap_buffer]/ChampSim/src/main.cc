...
void print_roi_stats(uint32_t cpu, CACHE *cache)
{
  ...
  //  total_access += cache->roi_access[cpu][2]; // For Overhead Calculation 
 ...
 //   total_access += cache->roi_access[cpu][3]; // For Overhead Calculation 
...
// ===================================My Implementation Starts from here===========================================================
    ...
    //     set = maxHeap.top().second;
    //     cout<<"Frequency "<<freq<<" "<<"Set NO "<<set<<endl;
    //     maxHeap.pop();
    //     sum += freq;
    // }
          priority_queue<pair<int,int>> Eviction_Hot_copy ; 
          priority_queue<pair<int,int>, vector<pair<int,int>>, greater<pair<int,int>> > Eviction_Cold_copy ; 

          for(int i = 0; i < 2048; i++){
              Eviction_Hot_copy.push({freq_eviction[i],i});
          }
          for(int i = 0; i < 2048; i++){
              Eviction_Cold_copy.push({freq_eviction[i],i});
          }
          while(!Eviction_Hot_copy.empty() && Eviction_Hot_copy.size() != 1024){
              int fi = Eviction_Hot_copy.top().first;
              int se = Eviction_Hot_copy.top().second;
              Eviction_Hot_copy.pop();
              Eviction_Hot.push({fi,se});
          }

          while(!Eviction_Cold_copy.empty() && Eviction_Cold_copy.size() != 1024){
            int fi = Eviction_Cold_copy.top().first;
            int se = Eviction_Cold_copy.top().second;
            Eviction_Cold_copy.pop();
            Eviction_Cold.push({fi,se});
          }
...
priority_queue<pair<int,int>, vector<pair<int,int>>, greater<pair<int,int>> > Cold_Copy = Cold; 
    cout<<"*****************************************************************************\n";
    cout<<"Total Access: "<<total_access <<" , "<<"Number of Tag Comparsion: "<<num_tag_comp<<endl;
    cout<<"Overhead: "<<num_tag_comp/total_access<<endl;

    cout<<" Categorisation of sets based on accesses \n";
    cout<<"*****************\n";
    cout<<"     Very Hot     \n";
    cout<<"*****************\n";
    cout<< "Set No             Freq \n";
    cout<<Hot_Copy.top().second <<"             "<< Hot_Copy.top().first << endl;
    Hot_Copy.pop();
    cout<<"*****************\n";
    cout<<"      Hot     \n";
    cout<<"*****************\n";
    ...
    cout<<"*****************\n";
    cout<< "Set No             Freq \n";
    cout<<Cold_Copy.top().second <<"             "<< Cold_Copy.top().first <<endl;
    Cold_Copy.pop();
    cout<<"*****************\n";
    cout<<"     Cold     \n";
    cout<<"*****************\n";
    ...
    cout<<"Categorisation of sets based on Eviction \n";
    cout<<"*****************\n";
    cout<<"     Very Hot     \n";
    cout<<"*****************\n";

    cout<< "Set No             Freq \n";
    cout<<Eviction_Hot.top().second <<"             "<< Eviction_Hot.top().first<<endl;
    Eviction_Hot.pop();
    cout<<"*****************\n";
    cout<<"      Hot     \n";
    cout<<"*****************\n";
    ...
    cout<<"*****************\n";
    cout<< "Set No             Freq \n";
    cout<<Eviction_Cold.top().second <<"             "<< Eviction_Cold.top().first<<endl;
    Eviction_Cold.pop();
    cout<<"*****************\n";
    cout<<"     Cold     \n";
    cout<<"*****************\n";
